...
export const SubcriptionIcon = ({ size }) => {
  return (
    <svg
      width={size}
      height={size}
...
export const OpenMenuIcon = ({ size }) => {
  return (
    <svg
      width={size}
      height={size}
      ...
      xmlns="http://www.w3.org/2000/svg"
    >
      <g stroke="#63B3ED" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5">
        <path d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10ZM8.5 12h6" />
        <path d="m12.5 15 3-3-3-3" />
      </g>
    </svg>
  );
};
  ...
  return (
    ...
    >
      ...
      <path
        fill="#4299E1"
        fillRule="evenodd"
        d="m21.707 6.293-3-3-1.414 1.414L18.586 6h-.411c-1.038 0-1.881 0-2.573.061-.717.063-1.349.197-1.945.51a5 5 0 0 0-1.21.887c.241.393.43.8.594 1.21.113.283.223.593.332.923.151-.315.296-.523.457-.687a3 3 0 0 1 .755-.562c.275-.144.617-.238 1.193-.289C16.371 8.001 17.127 8 18.22 8h.366l-1.293 1.293 1.414 1.414 3-3L22.414 7l-.707-.707Zm-11.154 10.25a7.904 7.904 0 0 1-.594-1.21 16.421 16.421 0 0 1-.332-.924 2.484 2.484 0 0 1-.457.688c-.22.225-.475.415-.755.56-.275.145-.617.24-1.193.29-.593.052-1.349.053-2.442.053H3v2h1.825c1.038 0 1.881 0 2.572-.06.718-.064 1.35-.198 1.946-.51a5 5 0 0 0 1.21-.888Z"
        clipRule="evenodd"
      />
    </svg>
  );
